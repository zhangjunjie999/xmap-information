<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['commonservice:restaurant:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['commonservice:restaurant:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['commonservice:restaurant:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['commonservice:restaurant:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="restaurantList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="餐厅ID" align="center" prop="restaurantId" />
      <el-table-column label="餐厅名称" align="center" prop="name"  :show-overflow-tooltip='true'/>
      ...
      <el-table-column label="菜单" align="center" prop="menu"  :show-overflow-tooltip='true'/>
      <el-table-column label="菜系" align="center" prop="cuisine"  :show-overflow-tooltip='true'/>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="菜系" prop="cuisine">
          <el-input v-model="form.cuisine" placeholder="请输入菜系" />
        </el-form-item>
        <el-form-item label="推荐理由" prop="activityStatus">
          <el-input v-model="form.activityStatus" placeholder="请输入推荐理由" />
        </el-form-item>
        <el-form-item label="创建时间" prop="createDate">
          <el-date-picker clearable
...
<script>
import { listRestaurant, getRestaurant, delRestaurant, addRestaurant, updateRestaurant } from "@/api/commonservice/restaurant";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除餐饮推荐编号为"' + restaurantIds + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('commonservice/restaurant/export', {
        ...this.queryParams
