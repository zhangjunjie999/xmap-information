<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['commonservice:hotel:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['commonservice:hotel:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['commonservice:hotel:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['commonservice:hotel:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="hotelList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="ID" align="center" prop="accommodationId" />
...
<script>
import { listHotel, getHotel, delHotel, addHotel, updateHotel } from "@/api/commonservice/hotel";
...
export default {
  ...
  methods: {
    ...
    handleUpdate(row) {
      ...
      getHotel(accommodationId).then(response => {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除住宿推荐编号为"' + accommodationIds + '"的数据项？').then(function() {
        return delHotel(accommodationIds);
      }).then(() => {
        this.getList();
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('commonservice/hotel/export', {
        ...this.queryParams
