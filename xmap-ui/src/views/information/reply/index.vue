<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="建议ID" prop="suggestId">
        <el-input
          v-model="queryParams.suggestId"
          placeholder="请输入建议ID"
          clearable
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['information:reply:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['information:reply:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['information:reply:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['information:reply:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="replyList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="建议ID" align="center" prop="suggestId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="建议ID" prop="suggestId">
          <el-input v-model="form.suggestId" placeholder="请输入建议ID" />
        </el-form-item>
...
<script>
import { listReply, getReply, delReply, addReply, updateReply } from "@/api/information/reply";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除回复表编号为"' + ids + '"的数据项？').then(function() {
        return delReply(ids);
      }).then(() => {
        this.getList();
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('information/reply/export', {
        ...this.queryParams
