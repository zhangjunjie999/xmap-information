...
<script>
import { listParking, getWeather } from "@/api/information/parking";
  ...
  methods: {
    ...
    getList() {
      ...
      listParking(this.queryParams).then(response => {
        ...
        this.loading = false;
        const item = this.parkingList.find(item1 => item1.siteName === this.stationName || item1.siteName == '游客服务中心3号停车场(上)')
