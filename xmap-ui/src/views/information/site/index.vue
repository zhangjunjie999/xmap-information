...
<!--    />-->
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="标志" prop="sign">
          <el-input v-model="form.sign" placeholder="请输入标志" />
        </el-form-item>
...
<script>
import { listSite, getSite, delSite, addSite, updateSite } from "@/api/information/site";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除地点标志管理编号为"' + ids + '"的数据项？').then(function() {
        return delSite(ids);
      }).then(() => {
        this.getList();
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('information/site/export', {
        ...this.queryParams
