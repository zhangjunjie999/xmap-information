<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['information:image:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['information:image:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['information:image:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['information:image:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="imageList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="图片标题" align="center" prop="title" show-overflow-tooltip="true"/>
      <el-table-column label="图片名称" align="center" prop="name" show-overflow-tooltip="true"/>
      <el-table-column label="图片" align="center" prop="image" width="100" show-overflow-tooltip="true">
...
<script>
import { listImage, getImage, delImage, addImage, updateImage } from "@/api/information/image";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('information/image/export', {
        ...this.queryParams
