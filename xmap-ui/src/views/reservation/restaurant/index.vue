  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="就餐日期" prop="diningDate">
        <el-date-picker clearable
          v-model="queryParams.diningDate"
          type="date"
          value-format="yyyy-MM-dd"
          placeholder="请选择就餐日期">
        </el-date-picker>
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['reservation:restaurant:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['reservation:restaurant:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['reservation:restaurant:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['reservation:restaurant:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="restaurantList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="餐厅名称" align="center" prop="restaurantName" />
      ...
      <el-table-column label="就餐日期" align="center" prop="diningDate" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.diningDate, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="餐厅ID" prop="restaurantId">
          <el-input v-model="form.restaurantId" placeholder="请输入餐厅ID" />
        </el-form-item>
        <el-form-item label="餐厅名称" prop="restaurantName">
...
<script>
import { listRestaurant, getRestaurant, delRestaurant, addRestaurant, updateRestaurant } from "@/api/reservation/restaurant";
...
export default {
  ...
  methods: {
    ...
    handleUpdate(row) {
      ...
      getRestaurant(reservationId).then(response => {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除餐饮预约编号为"' + reservationIds + '"的数据项？').then(function() {
        return delRestaurant(reservationIds);
      }).then(() => {
        this.getList();
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('reservation/restaurant/export', {
        ...this.queryParams
